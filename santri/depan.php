    ...
    $sql = mysqli_query($conn, "select * from tbl_santri_baru where no_daftar='$no_daftar'");
	...
	$nama_foto = $_FILES['nama_file']['name'];
								...
								<div class="card custom-card">
									...
									<div class="card-body text-center item-user">
										<div class="profile-pic">
											...
											<a href="#" class="text-dark"><h5 class="mt-3 mb-0 font-weight-semibold"><?=$_SESSION['nama_santri'];?></h5></a>
										</div>
									</div>
									...
									<div class="card-body">
										<div class="tab-content" id="myTabContent">
											...
											<div class="tab-pane fade show active" id="profile" role="tabpanel">
												...
												<div class="py-2">
													<div class="row py-2">
														<div class="col-md-6"> <label id="last-name">Nama Santri</label> <input type="text" id="nama_santri" name="nama_santri" class="form-control" value="<?=$data['nama_santri'];?>" ></div>
													...
													<div class="row py-2">
														<div class="col-md-6"> <label id="tempat_lahir">Tempat Lahir</label> <input type="text" class="form-control" value="<?=$data['tempat_lahir'];?>"> </div>
													...
													<div class="row py-2">
														...
														<br>
														<input type="submit" name="simpan" class="form-control btn btn-sm btn-warning col-sm-4 center">
														</div>
														</form>
													</div>
												</div>
