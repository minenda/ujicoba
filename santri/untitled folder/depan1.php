												...
												<div class="row align-items-center">
													<div class="offset-lg-4 offset-sm-6 col-lg-8 col-sm-6 col-12">
														<h4 class="d-flex  mb-3">
															<span class="font-weight-bold text-white tx-white-20">Ahlan wa sahlan!</span>
														</h4>
														<label class="text-white tx-16 font-weight-bold mb-1">Aplikasi akademik <?= $_SESSION['nama_sekolah'] ?></label>
													</div>
													<img src="../assets/img/pngs/graduate.png" alt="user-img" height="165px" width="245px">
												</div>
											</div>
										</div>
									</div>
										...
										<div class="card custom-card">
											<div class="card-body">
												<div class="card-item">
													...
													<div class="card-item-title mb-2">
														<label class="main-content-label tx-13 font-weight-bold mb-1">Santri Diterima</label>
														<span class="d-block tx-12 mb-0 text-muted">Jumlah Santri Yang Diterima</span>
													</div>
												...
												<div>
													<div class="d-md-flex">
														...
														<div class="ms-auto mt-3 d-flex">
															<div class="me-3 d-flex text-muted tx-13"><span class="legend bg-primary rounded-circle"></span>Project</div>
													...
													<table class="table card-table table-vcenter text-nowrap mb-0  border">
														...
														<tbody>
															<tr>
																...
																<td><span class="badge bg-pill bg-primary-light">Completed</span></td>
															</tr>
															<tr>
															...
															<tr>
																...
																<td class="text-center">37<i class=""></i></td>
																<td class="text-primary">High</td>
																<td><span class="badge bg-pill bg-danger-light">Rejected</span></td>
															</tr>
														</tbody>
													</table>
												</div>
									...
									<table class="table table-hover m-b-0 transcations mt-2">
										<tbody>
											<tr>
												...
												<td class="text-end">
													<div class="d-inline-block">
														<h6 class="mb-2 tx-15 font-weight-semibold">$45.234<i class="fas fa-level-up-alt ms-2 text-success m-l-10"></i></h6>
											 ...
											 <tr>
												...
												<td class="text-end">
													<div class="d-inline-block">
														<h6 class="mb-2 tx-15 font-weight-semibold">$23.452<i class="fas fa-level-down-alt ms-2 text-danger m-l-10"></i></h6>
											...
											<tr>
												...
												<td class="text-end">
													<div class="d-inline-block">
														<h6 class="mb-2 tx-15 font-weight-semibold">$78.001<i class="fas fa-level-down-alt ms-2 text-danger m-l-10"></i></h6>
											...
											<tr>
												...
												<td class="text-end">
													<div class="d-inline-block">
														<h6 class="mb-2 tx-15 font-weight-semibold">$37.285<i class="fas fa-level-up-alt ms-2 text-success m-l-10"></i></h6>
														<p class="mb-0 tx-11 text-muted">4 Apr 2020</p>
													</div>
												</td>
											</tr>
											<tr>
												...
												<td class="text-end pb-0">
													<div class="d-inline-block">
														<h6 class="mb-2 tx-15 font-weight-semibold">$25.341<i class="fas fa-level-down-alt ms-2 text-danger m-l-10"></i></h6>
														<p class="mb-0 tx-11 text-muted">4 Apr 2020</p>
													</div>
												</td>
											</tr>
