							...
							<div class="col-xl-3 col-lg-12 col-md-12">
								<div class="card custom-card">
									...
									<ul class="item1-links nav nav-tabs  mb-0">
										<li class="nav-item">
											<a href="?page=Home"  class="nav-link"><i class="ti-credit-card icon1"></i> Profil User</a>
										</li>
										<li class="nav-item">
											<a href="?page=listSantri" class="nav-link"><i class="ti-heart icon1"></i> Daftar Calon Santri</a>
										</li>
										<li class="nav-item">
