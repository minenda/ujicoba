							...
							<div class="col-xl-3 col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-header">
										<h3 class="main-content-label">Calon Santri Baru</h3>
									</div>
									...
									<ul class="item1-links nav nav-tabs  mb-0">
										<!--<li class="nav-item">
											<a data-bs-target="#orders" class="nav-link active" data-bs-toggle="tab" role="tablist"><i class="ti-user icon1"></i> Data Calon Santri</a>
										</li>-->
										<li class="nav-item">
											<a data-bs-target="#profile"  class="nav-link active" data-bs-toggle="tab" role="tablist"><i class="ti-credit-card icon1"></i> My Profile</a>
										</li>
										<li class="nav-item">
									...
									<div class="card-body">
										<div class="tab-content" id="myTabContent">
													...
													<table class="table border text-md-nowrap text-nowrap">
														...
														<tbody>
															<tr class="border-bottom">
																...
																<td><img src="../assets/img/pngs/17.png" class="img-sm product-image border" alt="product-img"></td>
															...
															<tr class="border-bottom">
																...
																<td><img src="../assets/img/pngs/18.png" class="img-sm product-image border" alt="product-img"></td>
															...
															<tr class="border-bottom">
																...
																<td><img src="../assets/img/pngs/15.png" class="img-sm product-image border" alt="product-img"></td>
															...
															<tr>
																...
																<td><img src="../assets/img/pngs/19.png" class="img-sm product-image border" alt="product-img"></td>
											...
											<div class="tab-pane fade" id="myaddres" role="tabpanel">
												<button type="button" class="btn btn-round btn-success mb-3"><i class="fe fe-plus-circle  me-2"></i>Add New Address</button>
												<div class="row">
												...
												<div class="table-responsive">
													<table class="table border text-nowrap">
														...
														<tbody>
															...
															<tr>
																<th scope="row">2</th>
																<td><img src="../assets/img/pngs/16.png" class="img-sm product-image border" alt="product-img"></td>
											...
											<div class="tab-pane fade" id="wallet" role="tabpanel">
												<div class="border p-4 text-center">
													...
													<a href="#" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Add Money</a>
												</div>
											...
											<div class="tab-pane fade show active" id="profile" role="tabpanel">
												...
												<div class="py-2">
													<div class="row py-2">
														<div class="col-md-6"> <label id="last-name">Nama</label> <input type="text" id="nama" name="nama" class="form-control" value="<?=$data['nama'];?>" ></div>
														<div class="col-md-6 pt-md-0 pt-3"> <label id="last-name">No HP</label> <input type="text" class="form-control" value="<?=$data['no_hp'];?>"> </div>
													</div>
													<div class="row py-2">
														<div class="col-md-6"> <label id="tempat_lahir">Alamat</label> <input type="text" class="form-control" value="<?=$data['alamat'];?>"> </div>
														<div class="col-md-6 pt-md-0 pt-3"> <label id="phoneno">Email</label> <input type="tel" class="form-control" value="<?=$data['email'];?>"> </div>
													</div>
													<!--<div class="row py-2">
														<div class="col-md-6"> <label id="tempat_lahir">Tanggal Lahir</label> <input type="date" class="form-control" value="<?=$data['tgl_lahir'];?>"> </div>
													...
													<div class="row py-2">
														...
														<br>
														<div style="text-align: center;"><button type="submit" name="simpan" class="btn btn-warning col-sm-4 center">Simpan</button></div>
														</div>
														</form>
													</div>
												</div>
