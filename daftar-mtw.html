...
$tahunDaftar      = date('Y');
        ...
        //$run_query = mysqli_query($conn, $cek_user);
				...
				$insert = mysqli_query($conn, "INSERT INTO tbl_santri_baru(nama_santri, no_daftar, nik, pass, password, nisn, tempat_lahir, tgl_lahir, jk, alamat, telp, email, asal_sekolah, prodi, status) VALUES ('$namaSantri', '$no_daftar', '$nik', '$password_plain', '$password', '$nisn', '$tempatLahir', '$tanggalLahir', '$jenisKelamin', '$alamat', '$telp', '$email', '$asalSekolah', '$prodi', '0')");
